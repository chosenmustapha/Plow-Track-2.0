...
delay(2000); // sets delay of 60 seconds before sending new text message
 ...
 delay(1000);
 ShowSerialData();
 mySerials.println("AT+SAPBR=3,1,\"APN\",\"fast.t-mobile.com\"");//setting the APN, the second need you fill in your local apn server
 delay(4000);
 ShowSerialData();
